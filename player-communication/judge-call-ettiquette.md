...
{% hint style="success" %}
Some settings, such as streamed games with a large audience, can permit general and untargeted questions about the match state that may either clarify any communication or alert staff to a potential violation, after which they may interject for further investigation.
{% endhint %}
...
* Do not suggest what you think _should_ be the infraction and penalty unless such input is solicited or permitted. Players should never ask for or insist that another player is to be penalized; that is at the sole discretion of the judges and tournament staff.

{% hint style="danger" %}
Judges should also refrain from offering advice or opinions on actual scenarios unless they were part of the original call. It is often difficult to reach the right conclusion without being able to examine each perspective on a situation.
{% endhint %}
